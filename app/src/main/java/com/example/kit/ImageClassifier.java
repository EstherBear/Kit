...
import com.example.kit.model.BaseAngle;
import com.example.kit.view.DrawView;
...
//            Log.d("Bodypoint", "index[" + k + "] = " + " " + result[0] + " " + result[1] + " ");
    ...
    private void compareAccuracy(float[][] resultArr) {
        ...
        for (int i = 0; i < 6; i++) {
            ...
            percentageList.add((i + 1)+": Accur: " + String.format("%.2f", percentage) + "%");
        }
  ...
  */
    ...
    private MappedByteBuffer loadModelFile(Activity activity) throws IOException {
        AssetManager myAsset= activity.getAssets();
        AssetFileDescriptor fileDescriptor = myAsset.openFd(getModelPath());
